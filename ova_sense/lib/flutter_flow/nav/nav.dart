...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Info1Widget.routeName,
          path: Info1Widget.routePath,
          builder: (context, params) => Info1Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Info4Widget.routeName,
          path: Info4Widget.routePath,
          builder: (context, params) => Info4Widget(),
        ),
        FFRoute(
